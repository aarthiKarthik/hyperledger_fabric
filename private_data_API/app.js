...
app.post('/channels/:channelName/chaincodes', async function(req, res) {
	...
	if (!collectionsConfigPath) {
		res.json(getErrorMessage('\'collectionsConfigPath\''));
		return;
	}
	let message = await instantiate.instantiateChaincode(peers, channelName, chaincodeName, chaincodeVersion, chaincodeType, fcn, args, collectionsConfigPath, req.username, req.orgname);
	res.send(message);
});
